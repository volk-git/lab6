...
public void bounce(BouncingBall ball1, BouncingBall ball2) {
    ...
    if (distance <= ball1.radius + ball2.radius) {
        ...
        double targetX = ball1.x + Math.cos(angle) * (ball1.radius + ball2.radius);
        double targetY = ball1.y + Math.sin(angle) * (ball1.radius + ball2.radius);
        double ax = (targetX - ball2.x) * 0.05;
        double ay = (targetY - ball2.y) * 0.05;
        ball1.speedX -= ax;
        ball1.speedY -= ay;
        ball2.speedX += ax;
        ball2.speedY += ay;
